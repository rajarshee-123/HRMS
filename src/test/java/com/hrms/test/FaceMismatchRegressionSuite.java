...
public class FaceMismatchRegressionSuite {
	...
	RegistrationRequestRegressionSuite registrationRequestRegressionSuite;
	...
	public void verifyRosterManagement() {
		try {
			...
			faceMismatch.faceMismatchfunction();
			faceMismatch.goTORegistrationRequest();
			Assert.assertEquals(true, faceMismatch.verifyemployeeFaceMismatchpage()); // Verifying valid login scenario.
		} catch (Exception e) {
